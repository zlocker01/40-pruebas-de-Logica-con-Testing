...
console.log(coincidencias('Hola soy una palabra en una frase, acompañada de otra palabra', 'palabra'));
console.log(coincidencias('Soy la frase en cuestión', 'Diego'));
